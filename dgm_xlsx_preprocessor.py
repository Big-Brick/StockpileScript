...
def CreateDefaultPreprocessRules(PathToRules: Path) -> None:
	...
	AddIgnorePattern(IgnoredTexts, "generic_context_word_pair", "Rows containing at least two separate context words that cannot be an element designation", r"\b(?:на|у|в|н[іи]й|ньому|якому|якій|яких|який|яка|яке|де|що|цей|ця|це|цьому|цій)\b.*\b(?:на|у|в|н[іи]й|ньому|якому|якій|яких|який|яка|яке|де|що|цей|ця|це|цьому|цій)\b")
